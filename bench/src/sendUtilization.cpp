...
namespace bench
{
  ...
  template long long unsigned computeLocNonorigin<2>(ot::DA<2> *octDA, const ot::DistTree<unsigned, 2> &distTree);
  template long long unsigned computeLocNonorigin<3>(ot::DA<3> *octDA, const ot::DistTree<unsigned, 3> &distTree);
  template long long unsigned computeLocNonorigin<4>(ot::DA<4> *octDA, const ot::DistTree<unsigned, 4> &distTree);
